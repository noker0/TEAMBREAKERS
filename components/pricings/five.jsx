...
const Five = () => {
  return (
    <>
        <div className="w-[1160px] gap-[50px] h-[770px] bg-[black] border-[4px] border-[#AA00FA] rounded-[50px] flex justify-center items-center hover:shadow-[grey] duration-300 hover:translate-x-[10px]  hover:translate-y-[-10px] hover:shadow-[-15px_15px_0_0_rgba(0,0,0,0.3)] mb-[20px] border-white">
        <div className="left pt-[43px] pl-[50px]">
          <Image src={dev} className='w-[500px] h-[750px]'/>
        </div>
        <div className="right">
            <p className='text-[#AA00FA] font-bold text-[50px]'>КОМПЛЕКТ ГЕЙМЕР </p>
            ...
            <div className="flex items-center justify-between pr-[50px]">
              <p className='text-[#AA00FA] font-bold text-[50px]'>от 65$</p>
