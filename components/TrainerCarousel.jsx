    ...
    <div className="w-full flex-shrink-0 px-4 ">
      <div className="bg-black border border-[#AA00FA] rounded-lg p-6 relative overflow-hidden h-[580px]">
        <div className="flex flex-col h-full space-y-4">
          ...
          <div className="relative w-48 h-48 mx-auto rounded-full border-2 border-[#AA00FA] overflow-hidden">
            <Image
              src={trainer.image}
          ...
          <ul className="text-white space-y-2    ">
            {trainer.achievements.map((achievement, idx) => (
              <li className='hover:text-[#AA00FA] duration-300 font-bold cursor-pointer hover:bg-[white] p-[5px]' key={idx}>{achievement}</li>
            ))}
          </ul>
